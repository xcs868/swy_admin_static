...
import poolBase from '@/api/gift/poolBase'

const crud = reactive({
  api: poolBase.getList,
  pageLayout: 'fixed',
  operationColumn: true,
  operationColumnWidth: 90,
  labelWidth: '170px',
  edit: { show: true, text: '编辑', api: poolBase.update, auth: ['gift:poolBase:update'] }
})
...
<script>
// export default { name: 'gift:poolBase' }
</script>
